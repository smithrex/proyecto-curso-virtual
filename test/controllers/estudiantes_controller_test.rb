...
class EstudiantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estudiante" do
    assert_difference('Estudiante.count') do
      post estudiantes_url, params: { estudiante: { app_materno: @estudiante.app_materno, app_paterno: @estudiante.app_paterno, curso_id: @estudiante.curso_id, nombre: @estudiante.nombre } }
    end
  ...
  test "should update estudiante" do
    patch estudiante_url(@estudiante), params: { estudiante: { app_materno: @estudiante.app_materno, app_paterno: @estudiante.app_paterno, curso_id: @estudiante.curso_id, nombre: @estudiante.nombre } }
